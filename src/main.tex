...
su dominio. Así, cada columna de la matríz es el resultado de aplicar la transformación a un elemento de la base.

Estudiar transformaciones lineales por medio de matríces hace más claro y computacional lo que prosigue. Además, el concepto de matríz escapa el de transformación lineal, siendo una
